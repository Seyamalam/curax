...
export const AppointmentConfirmation: React.FC<AppointmentConfirmationProps> = ({ time, doctor }) => (
  <div className="my-2">
    ...
    <DoctorCard {...doctor} />
    <div className="text-xs text-zinc-400 mt-2">Time: {time ? new Date(time).toLocaleString() : ''}</div>
  </div>
); 
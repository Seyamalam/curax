...
async function seedDoctors() {
  ...
  await db.insert(doctors).values([
    ...
    },
    {
      ...
      fees: 100,
      bio: 'Loves working with children and families.',
    },
    {
      name: 'Dr. David Kim',
      specialty: 'Neurology',
      ...
      fees: 200,
      bio: 'Focus on neurological disorders and research.',
    },
    {
      name: 'Dr. Emily Chen',
      ...
      availability: 'Mon-Fri 9am-5pm',
      fees: 180,
      bio: 'Orthopedic surgeon with a passion for sports medicine.',
    },
    {
      name: 'Dr. Frank Wang',
      specialty: 'Urology',
      ...
      fees: 130,
      bio: 'Urology specialist with a patient-centered approach.',
    },
    {
      name: 'Dr. Grace Liu',
    ...
    },
    {
      ...
      fees: 160,
      bio: 'Expert in diabetes and hormonal disorders.',
    },
    {
      name: 'Dr. Isabella Garcia',
      specialty: 'Hematology',
      hospital: 'Blood Institute',
      experience: 10,
      availability: 'Mon-Fri 8am-2pm',
      fees: 170,
      bio: 'Researcher and clinician in blood diseases.',
    },
    {
      name: 'Dr. John Doe',
    ...
    },
    {
      ...
      fees: 155,
      bio: 'Senior cardiologist and educator.',
    },
    {
      ...
      hospital: 'SkinCare Clinic',
      experience: 5,
      availability: 'Wed, Fri 12pm-5pm',
      fees: 110,
      bio: 'Focus on acne and skin cancer prevention.',
    },
    {
      ...
      fees: 105,
      bio: 'Pediatrician with a gentle touch.',
    },
    {
      name: 'Dr. Paul Miller',
      specialty: 'Neurology',
      ...
      availability: 'Tue, Thu 10am-4pm',
      fees: 210,
      bio: 'Specialist in epilepsy and migraines.',
    },
    {
      name: 'Dr. Quinn Nguyen',
      specialty: 'Pediatrics',
      hospital: 'Family Clinic',
      experience: 7,
      availability: 'Mon, Wed, Fri 8am-2pm',
      fees: 95,
      bio: 'Caring for children of all ages.',
    },
    {
      name: 'Dr. Rachel Kim',
      specialty: 'Cardiology',
    ...
    },
    {
      ...
      availability: 'Mon-Fri 10am-4pm',
      fees: 135,
      bio: 'Advocate for women’s reproductive health.',
    },
    {
      name: 'Dr. Uma Patel',
      specialty: 'Endocrinology',
      ...
      availability: 'Mon, Wed, Fri 9am-1pm',
      fees: 150,
      bio: 'Thyroid and metabolic disorder specialist.',
    },
    {
      name: 'Dr. Victor Wang',
      specialty: 'Hematology',
      ...
      availability: 'Mon-Fri 8am-2pm',
      fees: 165,
      bio: 'Blood disorder researcher and clinician.',
    },
    {
    ...
    },
    {
      ...
      fees: 140,
      bio: 'Cardiologist with international experience.',
    },
    {
      name: 'Dr. Yvonne Kim',
      specialty: 'Dermatology',
      ...
      fees: 115,
      bio: 'Dermatologist focused on patient education.',
    },
    {
      name: 'Dr. Zara Patel',
      specialty: 'Pediatrics',
      ...
      availability: 'Mon-Fri 8am-3pm',
      fees: 100,
      bio: 'Pediatrician with a love for teaching.',
    },
    {
      name: 'Dr. Aiden Chen',
      specialty: 'Orthopedics',
      ...
      availability: 'Mon-Fri 9am-5pm',
      fees: 170,
      bio: 'Orthopedic surgeon and sports medicine expert.',
    },
    {
      name: 'Dr. Benjamin Wang',
      specialty: 'Urology',
      hospital: 'General Hospital',
      experience: 6,
      availability: 'Tue, Thu 10am-2pm',
      fees: 125,
      bio: 'Urologist with a focus on minimally invasive procedures.',
    },
  ]);
